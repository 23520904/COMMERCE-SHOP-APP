      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            <Link
              to={"/"}
              className="text-gray-300 hover:text-emerald-400 transition duration-300 ease-initial"
            >
              Home
            </Link>
            {user && (
            ...
            {user ? (
              ...
              <>
                <Link
                  to={"/signup"}
                  className="bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 rounded-md flex items-center transtition duration-300 ease-in-out"
                >
